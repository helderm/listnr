...
def mfsc(signal,samplerate=16000,winlen=0.025,winstep=0.01,numcep=13,
    ...
    feat = numpy.log(feat)
    # For ConvNets, no DCT is applied to the speech signal since we lose the locality information
    # see research.microsoft.com/pubs/230894/TASLP2339736-proof.pdf
