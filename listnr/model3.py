...
def inference(frames):
    ...
    # norm1
    norm1 = tf.nn.lrn(conv1, 5, bias=2.0, alpha=0.001 / 9.0, beta=0.75,
                          name='norm1')

    # pool1
    pool1 = tf.nn.max_pool(norm1, ksize=[1, 6, 1, 1], strides=[1, 1, 1, 1],
    ...
    # norm2
    norm2 = tf.nn.lrn(conv1, 5, bias=2.0, alpha=0.001 / 9.0, beta=0.75,
                          name='norm1')

    # pool2
    pool2 = tf.nn.max_pool(norm2, ksize=[1, 6, 1, 1], strides=[1, 1, 1, 1],
                           padding='SAME', name='pool1')
